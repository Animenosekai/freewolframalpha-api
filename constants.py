...
QUERY_URL = "https://api.wolframalpha.com/v2/query?appid={appID}&input={input}&podstate=Step-by-step+solution&podstate=Step-by-step&podstate=Show+all+steps&scantimeout={timeout}&podstate={podstate}"
